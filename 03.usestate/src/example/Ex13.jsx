...
const Ex13 = () => {
    ...
    const key = 'd383da31bbcadb909f49678b852ad8ac'
    ...
    <div className='weather-container'>
        ...
        <div className='weather-item'>
            ...
            <div className='button-wrapper'>
                <button onClick={() => handleCity('Osaka')}>오사카</button>
                <button onClick={() => handleCity('Paris')}>파리</button>
                <button onClick={() => handleCity('London')}>런던</button>
            </div>
        </div>
    </div>
  )
